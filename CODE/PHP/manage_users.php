...
/* SESSION SECURITY: enforce 10-minute timeout, same as admin_dashboard.php.
   This was missing here, which meant an idle session on Manage Users never
   timed out server-side even though every other admin page enforces it. */
...
<script>
    /* SESSION SECURITY: client-side inactivity auto logout (matches admin_dashboard.php) */
    (function () {
